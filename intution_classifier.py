...
def intutive_prediction(iso_objs, heads):
...
def cls_main(args):
    ...
    train_objset, test_objset = create_objs_set(args.train_obj_files, args.test_obj_files, args.csv, train_cls_info)
    ...
    for img, act_cls in train_cls_info.iteritems():
        prob, pred_cls = intutive_prediction(iso_objs=train_objset[img], heads=train_heads[img])
